...
contract ERC20 is Context, IERC20, IERC20Metadata {
    //changed visibility from priv to internal
...
/**
 * @notice ERC20 utility token with a dynamic holder tier tracker
 */
contract Token is ERC20, Ownable {
    ...
    //*****
    mapping(address => UserRank) public rank;

    constructor() ERC20("Agreed", "AGRD") {
    ...
    function _transfer(
        ...
        //this is where the rank is updated for any change in user token balance
        //*****
        updateRank(from);
        updateRank(to);
    }
    ...
    function hasRank(address _holder, UserRank _rank)
        public
        view
        returns (bool)
    {
